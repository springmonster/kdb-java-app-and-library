...
public class KdbRetrieveConverter {
    ...
    public static List<Map<String, Object>> convertToList(Object obj) throws UnsupportedEncodingException {
    ...
    private static List<Map<String, Object>> combineColumnsAndRows(String[] columns, List<Object[]> rows) {
